...
<!--                </el-form-item>-->
                <el-form-item label="车牌号：" prop="car_number">
                    <el-input v-model="formData.car_number"></el-input>
                </el-form-item>
                <el-form-item label="违规内容：" prop="violation_type">
                    <el-input v-model="formData.violation_type"></el-input>
                </el-form-item>
...
<!--                </el-form-item>-->
                <el-form-item label="状态：" prop="has_paid">
                    <el-switch
...
<script>
    import {ViolationAdd,ViolationEdit,platformsettingsUploadPlatformImg} from "@/api/api";
