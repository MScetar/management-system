        ...
        <ly-crud ref="lycrud"  v-bind="crudConfig" >
            <template v-slot:customHandle="slotProps">
                <span class="table-operate-btn" @click="handleClick(slotProps.row,'disable')" v-show="hasPermission(this.$route.name,'Disable')">
                    <span v-if="slotProps.row.has_paid">已缴费</span>
                ...
                crudConfig:{
                    ...
                    searchBar:{
                        ...
                        searchColums:[
                            ...
                            {label:'违规时间',type:'datepicker-datetimerange',prop:'timers'},
                        ]
                    },
                    //显示分页
                    showPagination:true,
                    ...
                    tableColumns:[
                        ...
                        //  },
                         ...
                         {label:'违规内容',prop:'violation_type',type:'input',minWidth:'110',sortable: false,hidden:false,
                            form:{
                                //表单属性
                                span:12,
                                placeholder: '请输入违规内容',
                        ...
                        {label:'违规时间',prop:'violation_time',type:'input',minWidth:'110',sortable: false,hidden:false,
                            form:{
                                //表单属性
                                span:12,
                                placeholder: '请输入违规时间',
