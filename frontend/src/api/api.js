...
// 交通违章信息管理 列表
export const Violation= params => ajaxGet({url: `violation/violation/`,params})
// 交通违章信息管理 新增
export const ViolationAdd= params => ajaxPost({url: `violation/violation/`,params})
// 交通违章信息管理 编辑
export const ViolationEdit= params => ajaxPut({url: `violation/violation/`,params})
// 交通违章信息管理 删除
export const ViolationDelete= params => ajaxDelete({url: `violation/violation/`,params})
// 交通违章信息管理 缴费状态
export const ViolationPaid= params => ajaxPut({url: `violation/violation/pay_traffic_violation/`,params})
// 交通违章信息管理 导出
export const ViolationExportexecl= params => ajaxGet({url: `violation/violation/violation_exportexecl/`,params})
